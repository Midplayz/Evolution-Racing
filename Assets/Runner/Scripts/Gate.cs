    ...
    public class Gate : Spawnable
    {
        ...
        void ActivateGate()
        {
            switch (m_GateType)
            {
                ...
                case GateType.ChangeEvolution:
                    EvolutionBehaviour.instance.AdjustEvolution(Mathf.RoundToInt(m_Value));
                break;

                case GateType.ChangePopulation:
                    CrowdFormation.Instance.AdjustCrowd(Mathf.RoundToInt(m_Value));
                break;
            }
